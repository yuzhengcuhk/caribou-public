...
from core.methods.node.caribou.caribou_inf import Caribou
from core.methods.node.caribou.caribou_edp import EdgePrivCaribou
from core.methods.node.caribou.caribou_ndp import NodePrivCaribou
...
supported_methods = {
    ...
    'caribou-inf': Caribou,
    'caribou-edp': EdgePrivCaribou,
    'caribou-ndp': NodePrivCaribou,
}
